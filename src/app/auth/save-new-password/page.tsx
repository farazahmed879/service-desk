...
import { savePassword } from "@/services/authServices";
...
export default function FP() {
  ...
  const saveNewPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await savePassword(payload);
      if (!res) {
  ...
  return (
    <>
      <Breadcrumb pageName="save New Password" />
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full xl:w-1/2">
            <div className="w-full p-4 sm:p-12.5 xl:p-15">
              ...
              <form onSubmit={saveNewPassword} className="mt-4 space-y-4">
                <input
          ...
          <div className="hidden w-full p-7.5 xl:block xl:w-1/2">
            <div className="custom-gradient-1 overflow-hidden rounded-2xl px-12.5 pt-12.5 dark:!bg-dark-2 dark:bg-none">
              ...
              <p className="max-w-[375px] font-medium text-dark-4 dark:text-dark-6">
                update your password by completing the necessary fields below
              </p>
