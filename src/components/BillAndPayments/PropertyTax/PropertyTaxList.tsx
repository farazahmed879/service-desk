...
export default function PropertyTaxList({ records, onDelete }: ListProps) {
    ...
    return (
        <div className="w-full overflow-hidden">
                        <h2 className="mb-4 text-xl font-bold text-gray-700">Property Tax List</h2>

            <DataTable
                data={records}
                columns={columns}
                emptyMessage="No property tax records found."
            />
        </div>
    );
}
