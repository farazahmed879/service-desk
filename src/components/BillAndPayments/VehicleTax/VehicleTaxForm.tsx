            ...
            {!showForm ? (
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div className="flex items-center justify-between mb-4 border-b pb-4">
                        <h2 className="text-2xl font-bold text-gray-700 capitalize">Vehicle Tax Payment</h2>
                        <button
                            type="button"
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <InputField label="Registration Number" name="InvoiceNumber" register={register} placeholder="LEW-XXXX" />
                    ...
                    <InputField label="Vehicle Details" name="remarks" register={register} placeholder="Enter Vehicle Model/Year" textarea rows={3} />
