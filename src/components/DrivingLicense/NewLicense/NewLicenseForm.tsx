            ...
            {!showForm ? (
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div className="flex items-center justify-between mb-4 border-b pb-4">
                        <h2 className="text-2xl font-bold text-gray-700 capitalize">Apply for New License</h2>
                        <button
                            type="button"
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <InputField label="License Type" name="licenseType" register={register} placeholder="e.g. LTV, HTV, Motorcycle" />
                    </div>
