...
import RenewLicenseList from "@/components/DrivingLicense/RenewLicense/RenewLicenseList";
...
export default function RenewLicenseForm({ serviceType }: ServiceFormProps) {
        ...
        <div className="w-full rounded-xl border border-gray-200 bg-white p-6 shadow-md">
            {!showForm ? (
                <>
                    ...
                    <RenewLicenseList records={records} onDelete={handleDelete} />
                </>
            ) : (
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div className="flex items-center justify-between mb-4 border-b pb-4">
                        <h2 className="text-2xl font-bold text-gray-700 capitalize">Renew License Application</h2>
                        <button
                            type="button"
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <InputField label="License Number" name="licenseType" register={register} placeholder="Enter License Number" />
                        <InputField label="Previous Expiry Date" name="expiryDate" register={register} type="date" />
