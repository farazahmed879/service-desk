...
import TaxPaymentList from "@/components/Vehicle/TaxPayment/TaxPaymentList";
...
export default function TaxPaymentForm({ serviceType }: ServiceFormProps) {
        ...
        <div className="w-full rounded-xl border border-gray-200 bg-white p-6 shadow-md">
            {!showForm ? (
                <>
                    ...
                    <TaxPaymentList records={records} onDelete={handleDelete} />
                </>
            ) : (
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <InputField label="Invoice Number" name="InvoiceNumber" register={register} placeholder="INV-XXXXXX" />
